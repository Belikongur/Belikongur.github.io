...
let transparency = 1.8, h = 180;
let transparencyLoc, diffuseLoc;
...
window.onload = function init() {
    ...
    diffuseProduct = mult(lightDiffuse, hsv2rgb(180, 1.0, 1.0));
    ...
    transparencyLoc = gl.getUniformLocation(program, "transparency");
    ...
    window.addEventListener("keydown", (e) => {
        console.log("TRANSPARANCY: " + transparency);
        console.log("H: " + h);
        switch (e.key) {
            case "ArrowDown":
                if (transparency > 0.0) transparency -= 0.1;
                break;
            case "ArrowUp":
                if (transparency < 4.0) transparency += 0.1;
                break;
            case "ArrowRight":
                if (h <= 355) h += 5;
                break;
...
function render() {
    ...
    diffuseProduct = mult(lightDiffuse, hsv2rgb(h, 1.0, 1.0));

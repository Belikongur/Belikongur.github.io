    ...
    window.addEventListener("keydown", function (e) {
        switch (e.keyCode) {
            ...
            case 56:	// 8: from beside the car
                ...
                break;
            case 57:    // 9: From house at car
                view = 9;
                document.getElementById("Viewpoint").innerHTML = "9: Horft á bíl frá húsi";
                break;
...
function render() {
    ...
    switch (view) {
        ...
        case 8:
            ...
            break; 99
        case 9:
            // View from house at car
            mv = lookAt(vec3(-40.0, 140.0, 18.0 + height), vec3(carXPos, carYPos, 0.0), vec3(0.0, 0.59, 1.0));
            drawScenery(mv);
            mv = mult(mv, translate(carXPos, carYPos, 0.0));
            mv = mult(mv, rotateZ(-carDirection));
            drawCar(mv);
